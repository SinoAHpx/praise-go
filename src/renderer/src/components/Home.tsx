...
const Home: React.FC<HomeProps> = ({ onShowSettings }) => {
  ...
  return (
    <div className="flex h-full">
      ...
      {/* Side Panel */}
      <div className={`fixed right-0 top-0 h-full bg-white dark:bg-gray-800 shadow-lg overflow-y-auto ${isRunning ? 'w-0 opacity-0' : 'w-64 opacity-100'}`}>
        <div className="p-6">
          <div className="flex justify-between items-center mb-4">
            <h2 className="text-xl font-bold">Statistics</h2>
            <button onClick={onShowSettings} className="text-gray-500 hover:text-gray-700">
